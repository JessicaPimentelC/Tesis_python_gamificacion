...
const Dieciocho = () => {
  ...
  const checkAnswer = () => {
    ...
    if (
      areaInput.trim() === correctAreaInput &&
      printInput.trim() === correctPrintInput
    ) {
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  Completa el código para calcular el área del cuadrado. Usa los
                  campos de entrada para ingresar las respuestas:
                </p>
                <ul>
                  <li>
                    Para calcular el área, escribe `lado ** 2` en el primer
                    campo.
                  </li>
                  <li>
                    Para imprimir el resultado, escribe `print` en el segundo
                    campo.
                  </li>
                </ul>
                <div className="code-box">
                  ...
                  <div className="code-content">
                    <pre>
                      lado = float(input("Ingresa la longitud del lado del
                      cuadrado: "))
                      <br />
                      <input
                        type="text"
